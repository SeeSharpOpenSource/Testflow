...
namespace Testflow.Modules
{
    ...
    public interface IParameterChecker : IController
    {
        ...
        /// <returns>检查过程中出现的告警信息</returns>
        IList<IWarningInfo> CheckParameters(IDictionary<string, IComInterfaceDescription> components, ISequenceGroup sequenceGroup);
        ...
        /// <returns>检查过程中出现的告警信息</returns>
        IList<IWarningInfo> CheckParameters(IDictionary<string, IComInterfaceDescription> components, ISequenceGroup sequenceGroup, ISequence sequence);
    }
}