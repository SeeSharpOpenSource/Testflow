...
{
    internal class LoopStepEntity : StepTaskEntityBase
    {
        public LoopStepEntity(ISequenceStep step, SlaveContext context, int sequenceIndex) : base(step, context, sequenceIndex)
        {
